...
STATUS_MESSAGES = ['HEY, I am using Spy Chat','BE the change you want to be', 'Keep it SIMPLE']



print "HeY! Let's Chat"
        ...
        while show_menu:
            ...
            if len(menu_choice) > 0:
                ...
                if menu_choice == 1:
                  ...
                  read_chat_history()cdc
                else:
                    show_menu = False
    else:
        print '"Invalid age.Not Older to Access it!!"'
...
if existing == "Y":
  ...
  spy.name = raw_input("Welcome to spy chat, HEY, what's your name ")
